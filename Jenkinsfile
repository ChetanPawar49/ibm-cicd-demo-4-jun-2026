...
pipeline {
    ...
    environment {
        IMAGE_NAME = "chetanpawar49/ibm-cicd-demo"
    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/ChetanPawar49/ibm-cicd-demo-4-jun-2026.git'
            }
        }
        ...
        stage('Docker Push') {
            ...
            // }
            steps {
                withCredentials([usernamePassword(credentialsId: 'dockerhub-creds', usernameVariable: 'chetanpawar49', passwordVariable: 'chetan')]) {
